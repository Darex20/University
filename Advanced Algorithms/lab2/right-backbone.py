...
assert root.left.value == 59
assert root.left.left.value == 48
assert root.left.left.left.value == 19
assert root.left.left.left.left.value == 9
assert root.left.left.left.left.left.value == 7